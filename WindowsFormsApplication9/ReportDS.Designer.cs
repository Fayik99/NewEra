...
namespace WindowsFormsApplication9.ReportDSTableAdapters {
...
SELECT itemCode, itemName, itemPrice, itemQty, supID FROM Item WHERE (itemCode = @itemCode)";
        ...
        public virtual int Fill(ReportDS.ItemDataTable dataTable) {
        ...
        public virtual ReportDS.ItemDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ReportDS.ItemDataTable dataTable = new ReportDS.ItemDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ReportDS.ItemDataTable dataTable) {
