...
namespace WindowsFormsApplication9 {
    ...
    public partial class stockDataSet : global::System.Data.DataSet {
        ...
        public partial class ItemDataTable : global::System.Data.TypedTableBase<ItemRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ItemRow AddItemRow(string itemName, string itemPrice, int itemQty, int supID) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ItemRow FindByitemCode(int itemCode) {
        ...
        public partial class ItemRow : global::System.Data.DataRow {
            ...
            public string itemPrice {
                get {
                    return ((string)(this[this.tableItem.itemPriceColumn]));
                }
                set {
            ...
            public int itemQty {
                get {
                    return ((int)(this[this.tableItem.itemQtyColumn]));
                }
                set {
                    this[this.tableItem.itemQtyColumn] = value;
                }
            }
            ...
            public int supID {
                get {
                    return ((int)(this[this.tableItem.supIDColumn]));
                }
                set {
...
namespace WindowsFormsApplication9.stockDataSetTableAdapters {
    ...
    public partial class ItemTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Item] WHERE (([itemCode] = @Original_itemCode) AND ([itemName]" +
                " = @Original_itemName) AND ([itemPrice] = @Original_itemPrice) AND ([itemQty] = " +
                "@Original_itemQty) AND ([supID] = @Original_supID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Item] ([itemName], [itemPrice], [itemQty], [supID]) VALUES (@i" +
                "temName, @itemPrice, @itemQty, @supID);\r\nSELECT itemCode, itemName, itemPrice, i" +
                "temQty, supID FROM Item WHERE (itemCode = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Item] SET [itemName] = @itemName, [itemPrice] = @itemPrice, [itemQty] = @itemQty, [supID] = @supID WHERE (([itemCode] = @Original_itemCode) AND ([itemName] = @Original_itemName) AND ([itemPrice] = @Original_itemPrice) AND ([itemQty] = @Original_itemQty) AND ([supID] = @Original_supID));
SELECT itemCode, itemName, itemPrice, itemQty, supID FROM Item WHERE (itemCode = @itemCode)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT itemCode, itemName, itemPrice, itemQty, supID FROM dbo.Item";
        ...
        public virtual int Fill(stockDataSet.ItemDataTable dataTable) {
        ...
        public virtual stockDataSet.ItemDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            stockDataSet.ItemDataTable dataTable = new stockDataSet.ItemDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(stockDataSet.ItemDataTable dataTable) {
        ...
        public virtual int Delete(int Original_itemCode, string Original_itemName, string Original_itemPrice, int Original_itemQty, int Original_supID) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_itemQty));
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_supID));
        ...
        public virtual int Insert(string itemName, string itemPrice, int itemQty, int supID) {
            if ((itemName == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((int)(itemQty));
        ...
        public virtual int Update(string itemName, string itemPrice, int itemQty, int supID, int Original_itemCode, string Original_itemName, string Original_itemPrice, int Original_itemQty, int Original_supID, int itemCode) {
            if ((itemName == null)) {
                throw new global::System.ArgumentNullException("itemName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(itemQty));
            ...
            if ((Original_itemPrice == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_itemPrice));
            }
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_itemQty));
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_supID));
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(itemCode));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string itemName, string itemPrice, int itemQty, int supID, int Original_itemCode, string Original_itemName, string Original_itemPrice, int Original_itemQty, int Original_supID) {
            return this.Update(itemName, itemPrice, itemQty, supID, Original_itemCode, Original_itemName, Original_itemPrice, Original_itemQty, Original_supID, Original_itemCode);
        }
    }
